...
'A review of your activity %(activity)s has been created or updated by %(user)s.': 'Se ha creado o actualizado una revisión de su actividad %(activity)s por el usuario %(user)s.',
'A review of your activity has been created or updated by %(user)s.': 'Se ha creado o actualizado una revisión de su actividad por el usuario %(user)s.',
'A review of your activity has been created or updated by %(user)s.\r\n': 'Se ha creado o actualizado una revisión de su actividad por el usuario %(user)s.\r\n',
'About': 'Acerca de',
...
'ACTIVITY': 'ACTIVIDAD',
'Activity': 'Actividad',
'Activity %(activity)s review': 'Revisión de actividad %(activity)s',
'Activity %s Confirmed. Thank you!': 'Actividad %s Confirmada. ¡Gracias!',
'Activity A depende de B: usar "doit" to "do it". Confirmed. Thank you!': 'Activity A depende de B: usa "doit" to "do it". Confirmed. Thank you!',
'Activity accepted': 'Actividad aceptada',
...
'Activity comment': 'Comentario de actividad',
'Activity comment: "%(activity)s"': 'Comentario de actividad "%(activity)s"',
...
'Activity confirmed': 'Actividad confirmada',
...
'Crawley': 'Crawley',
'Create a new account using social networks single sign-on': 'Crear una nueva cuenta usando  redes sociales',
'Create a non-attending registration for yourself first!': 'Create a non-attending registration for yourself first!',
'Create a traditional account using email/password': 'Crear una cuenta tradicional (email + contraseña)',
...
'Following is a copy of the submitted data': 'A continuación se adjunta una copia de los datos recibidos',
...
'Maps': 'Mapas',
'Marcar para eliminar:': 'Marcar para eliminar:',
...
'New activity proposal %(activity)s': 'Nueva propuesta de actividad %(activity)s',
...
'small': 'small',
'social': 'social',
'Social networks single sign-on': 'Inicio de sesión por redes sociales',
...
'Your activity %(activity)s has been confirmed.\nYou can access the current activity information at %(link)s': 'Su actividad %(activity)s ha sido confirmada. Puede acceder a la información actual de la actividad en %(link)s',
'Your activity %(activity)s received a comment by %(user)s:\n%(comment)s\n': 'Su actividad %(activity)s recibió un comentario de %(user)s:\r\n\r\n%(comment)s\r\n',
'Your activity proposal %(activity)s has been recorded.\nYou can access the current activity information at %(link)s\nThank you': 'Su propuesta de actividad %(activity)s ha sido registrada. Puede acceder a la información de la actividad en %(link)s.\r\n\r\nGracias\r\n',
'Your activity proposal %(activity)s has been recorded.\r\n\r\nThank you\r\n': 'Se ha registrado su propuesta de actividad %(activity)s.\r\n\r\nGracias\r\n',
'Your activity proposal %(activity)s has been recorded. Thank you': 'Se ha registrado su propuesta de actividad %(activity)s.\r\n\r\nGracias\r\n',
'Your activity proposal has been recorded. Thank you': 'Se ha registrado su propuesta de actividad %(activity)s.\r\n\r\nGracias',
'Your activity received a comment by %(user)s.': 'Su actividad ha recibido un comentario de %(user)s',
...
"Your current granted permisions doesn't not give access to the requested resource": 'Su configuración de usuario no permite acceso al recurso solicitado.',
